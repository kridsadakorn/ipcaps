...
```
Alternatively, you can install the dev version of IPCAPS from [Gitlab](https://gitlab.com/chaichoompu/ipcaps) with
``` r
...
You can see the reference manual from: [https://chaichoompu.gitlab.io/ipcaps_doc/index.html](https://chaichoompu.gitlab.io/ipcaps_doc/index.html)
